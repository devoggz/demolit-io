...
import WishlistButton from "@/components/Wishlist/AddWishlistButton";
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-15">
                    ...
                    <div>
                        ...
                        <div className="space-y-3 border-t border-gray-3 pt-6">
                            ...
                            {product.category && (
                                <div className="flex items-center gap-2">
                                    <span className="text-sm font-medium text-dark-4">Category:</span>
                            ...
                            {product.tags && product.tags.length > 0 && (
                                <div className="flex items-start gap-2">
                                    <span className="text-sm font-medium text-dark-4 mt-0.5">Tags:</span>
