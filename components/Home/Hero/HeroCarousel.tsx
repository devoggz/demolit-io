      ...
      {sliders?.map((slider: IHeroSlider, key: number) => (
        <SwiperSlide key={key}>
          <div className="flex flex-col-reverse items-center pt-6 sm:pt-0 sm:flex-row">
            <div className="max-w-[394px] py-10 sm:py-15 lg:py-24.5 pl-4 z-10 sm:pl-7.5 lg:pl-12.5">
              ...
              <Link
                ...
                className="inline-flex py-3 mt-10 font-medium text-white duration-200 ease-out rounded-lg text-custom-sm bg-dark-6 px-9 hover:bg-green-bright"
              >
                Shop Now
              </Link>
            </div>
            <div>
              <Image
                src={
                  slider?.sliderImage ? slider?.sliderImage! : "/no-image.png"
                }
                alt="headphone"
                width={320}
                height={400}
