    ...
    return (
        ...
        >
            <div className="relative flex items-center group">
                ...
                <button
                    ...
                    className={`relative flex items-center justify-center w-[38px] h-[38px] border border-gray-3 rounded-lg ease-out duration-200 z-10 ${
                        icon === "check-out"
                            ...
                            : "text-dark-6 bg-white hover:text-white hover:bg-green-bright"
                ...
                {/* Tooltip */}
                <p
                    className={`absolute right-full  top-0 bg-white text-dark-6 text-xs leading-5 font-medium rounded-lg h-9 inline-flex items-center justify-center px-3  shadow-1 whitespace-nowrap transition-all duration-300 ${
